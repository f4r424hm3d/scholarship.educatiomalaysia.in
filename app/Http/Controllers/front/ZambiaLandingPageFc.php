...
class ZambiaLandingPageFc extends Controller
{
  public function index(Request $request)
  {
    $page_slug = 'education-fair-in-zambia-2025';
    ...
    return view('front.education-fair-in-zambia-2025')->with($data);
  }
  ...
  public function register(Request $request)
  {
    ...
    return redirect()->route('zambia.page');
  }
